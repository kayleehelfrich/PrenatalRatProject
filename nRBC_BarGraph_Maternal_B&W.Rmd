---
title: "Maternal Rat nRBCs with AIN-76A diet with MD or Alcohol and Iron Supplement or Water- GD20.5"
author: "Kaylee Helfrich"
date: "10/2/2020"
output: 
  pdf_document: default
  html_document: default
data: "Maternal_nRBCs_ForAnalysis.csv"
---
...
File <- "Maternal_nRBCs_ForAnalysis.csv"
...
#Make Graph#
png("Maternal_nRBCs_PAExFe_Dotplot_B&W.png", units="in", width=4, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Exposure, y=Mean)) + 
  ...
  ggtitle("Maternal nRBCs") +
  ylab(expression("Maternal nRBCs (#/100 WBCs)")) + 
