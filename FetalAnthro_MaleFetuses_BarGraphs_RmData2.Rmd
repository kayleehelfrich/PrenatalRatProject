...
Mean <- tapply(Males_new$Fetal.Wt, as.character(Males_new$Treatment), mean, na.rm=TRUE) #make sure to change selected column to change data for graph
...
Stdev <- tapply(Males_new$Fetal.Wt, as.character(Males_new$Treatment), sd, na.rm=TRUE) #make sure to change selected column
...
dataframe_combine <- cbind(Mean, Stdev, Males_new$Fetal.Wt) #make sure to change selected column
...
#Make Graph#
png("FetalWeight_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Mean
Mean <- tapply(Males_new$Placental.Wt, as.character(Males_new$Treatment), mean, na.rm=TRUE) #make sure to change 
Mean <- as.data.frame(rep(Mean, each = NumPoints))
Mean$Treatment <- rep(ActualGroupOrder, each = NumPoints) 
colnames(Mean)[1] <- "Mean"

#Stdev
Stdev <- tapply(Males_new$Placental.Wt, as.character(Males_new$Treatment), sd, na.rm=TRUE) #make sure to change 
Stdev <- as.data.frame(rep(Stdev, each = NumPoints))
Stdev$Treatment <- rep(ActualGroupOrder, each = NumPoints)
colnames(Stdev)[1] <- "Stdev"

#Combine
dataframe_combine <- cbind(Mean, Stdev, Males_new$Placental.Wt) #make sure to change
...
#Make Graph#
png("PlacentalWeight_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Placental Weight- Males") +
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
#Mean
Mean <- tapply(Males_new$Placental.Efficiency, as.character(Males_new$Treatment), mean, na.rm=TRUE) #change 
Mean <- as.data.frame(rep(Mean, each = NumPoints))
Mean$Treatment <- rep(ActualGroupOrder, each = NumPoints) 
colnames(Mean)[1] <- "Mean"

#Stdev
Stdev <- tapply(Males_new$Placental.Efficiency, as.character(Males_new$Treatment), sd, na.rm=TRUE) #change 
Stdev <- as.data.frame(rep(Stdev, each = NumPoints))
Stdev$Treatment <- rep(ActualGroupOrder, each = NumPoints)
colnames(Stdev)[1] <- "Stdev"

#Combine
dataframe_combine <- cbind(Mean, Stdev, Males_new$Placental.Efficiency) #make sure to change
colnames(dataframe_combine)[5] <- "Value"
dataframe_combine <- dataframe_combine[-2]
...
#Make Graph#
png("PlacentalEfficiency_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Placental Efficiency- Males") +
...
#Make Graph#
png("FetalBrainWeight_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBraintoBodyWeightRatio_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Fetal Brain to Body Weight Ratio- Males") +
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
#Mean
Mean <- tapply(Males_new$Liver.Wt, as.character(Males_new$Treatment), mean, na.rm=TRUE) #change 
Mean <- as.data.frame(rep(Mean, each = NumPoints))
Mean$Treatment <- rep(ActualGroupOrder, each = NumPoints) 
colnames(Mean)[1] <- "Mean"

#Stdev
Stdev <- tapply(Males_new$Liver.Wt, as.character(Males_new$Treatment), sd, na.rm=TRUE) #change 
Stdev <- as.data.frame(rep(Stdev, each = NumPoints))
Stdev$Treatment <- rep(ActualGroupOrder, each = NumPoints)
colnames(Stdev)[1] <- "Stdev"

#Combine
dataframe_combine <- cbind(Mean, Stdev, Males_new$Liver.Wt) #make sure to change
colnames(dataframe_combine)[5] <- "Value"
dataframe_combine <- dataframe_combine[-2]
...
#Make Graph#
png("FetalLiverWeight_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Fetal Liver Weight- Males") +
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
#Mean
Mean <- tapply(Males_new$Ratio.Liver.Body, as.character(Males_new$Treatment), mean, na.rm=TRUE) #change 
Mean <- as.data.frame(rep(Mean, each = NumPoints))
Mean$Treatment <- rep(ActualGroupOrder, each = NumPoints) 
colnames(Mean)[1] <- "Mean"

#Stdev
Stdev <- tapply(Males_new$Ratio.Liver.Body, as.character(Males_new$Treatment), sd, na.rm=TRUE) #change 
Stdev <- as.data.frame(rep(Stdev, each = NumPoints))
Stdev$Treatment <- rep(ActualGroupOrder, each = NumPoints)
colnames(Stdev)[1] <- "Stdev"

#Combine
dataframe_combine <- cbind(Mean, Stdev, Males_new$Ratio.Liver.Body) #make sure to change
colnames(dataframe_combine)[5] <- "Value"
dataframe_combine <- dataframe_combine[-2]
...
#Make Graph#
png("FetalLiverBodyWeightRatio_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Fetal Liver to Body Weight Ratio- Males") +
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
#Mean
Mean <- tapply(Males_new$Ratio.Brain.Liver, as.character(Males_new$Treatment), mean, na.rm=TRUE) #change 
Mean <- as.data.frame(rep(Mean, each = NumPoints))
Mean$Treatment <- rep(ActualGroupOrder, each = NumPoints) 
colnames(Mean)[1] <- "Mean"

#Stdev
Stdev <- tapply(Males_new$Ratio.Brain.Liver, as.character(Males_new$Treatment), sd, na.rm=TRUE) #change 
Stdev <- as.data.frame(rep(Stdev, each = NumPoints))
Stdev$Treatment <- rep(ActualGroupOrder, each = NumPoints)
colnames(Stdev)[1] <- "Stdev"

#Combine
dataframe_combine <- cbind(Mean, Stdev, Males_new$Ratio.Brain.Liver) #make sure to change
colnames(dataframe_combine)[5] <- "Value"
dataframe_combine <- dataframe_combine[-2]
...
#Make Graph#
png("FetalBraintoLiverWeightRatio_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Fetal Brain to Liver Weight Ratio- Males") +
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
#Mean
Mean <- tapply(Males_new$Heart.Wt, as.character(Males_new$Treatment), mean, na.rm=TRUE) #change 
Mean <- as.data.frame(rep(Mean, each = NumPoints))
Mean$Treatment <- rep(ActualGroupOrder, each = NumPoints) 
colnames(Mean)[1] <- "Mean"

#Stdev
Stdev <- tapply(Males_new$Heart.Wt, as.character(Males_new$Treatment), sd, na.rm=TRUE) #change 
Stdev <- as.data.frame(rep(Stdev, each = NumPoints))
Stdev$Treatment <- rep(ActualGroupOrder, each = NumPoints)
colnames(Stdev)[1] <- "Stdev"

#Combine
dataframe_combine <- cbind(Mean, Stdev, Males_new$Heart.Wt) #make sure to change
colnames(dataframe_combine)[5] <- "Value"
dataframe_combine <- dataframe_combine[-2]
...
#Make Graph#
png("FetalHeartWeight_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Fetal Heart Weight- Males") +
...
```{r, echo = FALSE, warning = FALSE, message = FALSE}
#Mean
Mean <- tapply(Males_new$Ratio.Heart.Body, as.character(Males_new$Treatment), mean, na.rm=TRUE) #change 
Mean <- as.data.frame(rep(Mean, each = NumPoints))
Mean$Treatment <- rep(ActualGroupOrder, each = NumPoints) 
colnames(Mean)[1] <- "Mean"

#Stdev
Stdev <- tapply(Males_new$Ratio.Heart.Body, as.character(Males_new$Treatment), sd, na.rm=TRUE) #change 
Stdev <- as.data.frame(rep(Stdev, each = NumPoints))
Stdev$Treatment <- rep(ActualGroupOrder, each = NumPoints)
colnames(Stdev)[1] <- "Stdev"

#Combine
dataframe_combine <- cbind(Mean, Stdev, Males_new$Ratio.Heart.Body) #make sure to change
colnames(dataframe_combine)[5] <- "Value"
dataframe_combine <- dataframe_combine[-2]
...
#Make Graph#
png("FetalHeartBodyWeightRatio_MalesOnly_RmData2_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Fetal Heart to Body Weight Ratio- Males") +
