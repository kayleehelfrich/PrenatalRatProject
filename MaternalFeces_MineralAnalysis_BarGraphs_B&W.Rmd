...
vector <- rep(c("ALC+Iron", "ALC", "CON+Iron", "CON"), times = c(AlcFe, AlcH2O, MDFe, MDH2O))
...
#Make Graph#
png("MaternalFeces_ICPOES_Iron_TotalIronInFeces_AllData_PAExFe_Dotplot_B&W.png", units="in", width=7, height=7, res=600) 
