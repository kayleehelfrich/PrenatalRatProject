...
#Make Graph#
png("MaternalLiver_ICPOES_Calcium_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("MaternalLiver_ICPOES_Copper_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("MaternalLiver_ICPOES_Iron_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("MaternalLiver_ICPOES_Potassium_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ylab(expression("Potassium (µg K/g dry weight tissue)")) + 
  theme(plot.title = element_text(hjust = 0.5, size=18), 
        axis.title.x = element_blank(), #gets rid of x-axis label
        axis.title.y = element_text(size = 16),
        panel.grid.major = element_blank(), #gets rid of major gridlines
...
#Make Graph#
png("MaternalLiver_ICPOES_Magnesium_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("MaternalLiver_ICPOES_Manganese_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("MaternalLiver_ICPOES_Phosphorus_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ylab(expression("Phosphorus (µg P/g dry weight tissue)")) + 
  theme(plot.title = element_text(hjust = 0.5, size=18), 
        axis.title.x = element_blank(), #gets rid of x-axis label
        axis.title.y = element_text(size = 16),
        panel.grid.major = element_blank(), #gets rid of major gridlines
...
#Make Graph#
png("MaternalLiver_ICPOES_Sulfur_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ylab(expression("Sulfur (µg S/g dry weight tissue)")) + 
  theme(plot.title = element_text(hjust = 0.5, size=18), 
        axis.title.x = element_blank(), #gets rid of x-axis label
        axis.title.y = element_text(size = 16),
        panel.grid.major = element_blank(), #gets rid of major gridlines
...
#Make Graph#
png("MaternalLiver_ICPOES_Silicon_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("MaternalLiver_ICPOES_Zinc_AllData_PAExFe_Dotplot.png", units="in", width=7, height=7, res=600) 
