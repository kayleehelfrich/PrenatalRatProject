...
#Make Graph#
png("FetalBrainWeight_FemalesOnly_RmData2_PAExFe_Dotplot_B&W.png", units="in", width=7, height=4, res=600) 
...
#Make Graph#
png("FetalBrainToBodyRatio_FemalesOnly_RmData2_PAExFe_Dotplot_B&W.png", units="in", width=7, height=4, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ggtitle("Fetal Brain to Body Ratio- Females") +
