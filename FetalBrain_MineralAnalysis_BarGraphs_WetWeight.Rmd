...
File <- "ICPOES_Mineral_FetalBrain_WetWeight.csv"
...
#Make Graph#
png("FetalBrain_ICPOES_Calcium_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  scale_y_continuous(expand = c(0,0), limits = c(-50,600)) +
...
FB_wout <- replace_with_na_all(data = FB$Calcium, condition = ~ .x > 100)
FB_wout <- t(FB_wout)
FB$Calcium2 <- FB_wout
...
#Make Graph#
png("FetalBrain_ICPOES_Calcium_woutOutliers_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
sets <- c("MD", "PAE", "MD-Iron", "PAE-Iron")
...
#Make Graph#
png("FetalBrain_ICPOES_Copper_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Iron_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Magnesium_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Manganese_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Sodium_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
p<- ggplot(dataframe_combine, aes(x=Treatment, y=Mean)) + 
  ...
  ylab(expression("Sodium (µg Na/g wet weight tissue)")) + 
  theme(plot.title = element_text(hjust = 0.5, size=18), 
        axis.title.x = element_blank(), #gets rid of x-axis label
        axis.title.y = element_text(size = 16),
        panel.grid.major = element_blank(), #gets rid of major gridlines
...
#Make Graph#
png("FetalBrain_ICPOES_Zinc_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Calcium_woutOutliers_Males_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
sets <- c("MD", "PAE", "MD-Iron", "PAE-Iron")
...
#Make Graph#
png("FetalBrain_ICPOES_Copper_Males_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Iron_Males_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Magnesium_Males_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Manganese_Males_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Sodium_Males_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Zinc_Males_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Calcium_woutOutliers_Females_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
sets <- c("MD", "PAE", "MD-Iron", "PAE-Iron")
...
#Make Graph#
png("FetalBrain_ICPOES_Copper_Females_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Iron_Females_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Magnesium_Females_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Manganese_Females_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Sodium_Females_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
...
#Make Graph#
png("FetalBrain_ICPOES_Zinc_Females_AllData_PAExFe_WetWt_Dotplot.png", units="in", width=7, height=7, res=600) 
